...
int main() {
    ...
    std::filesystem::path vertex_shader_path = shaderSourcePath / "ex_2/vertex.glsl";
    std::filesystem::path fragment_shader_path = shaderSourcePath / "ex_2/fragment.glsl";
    ...
    std::filesystem::path imagePath = assetsSourcePath / "woman_lowres.jpg";
    int x,y,n;
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        ImGui::SliderFloat("Bezel Width", &bezel_width, 5, 2000);
